...
Before using qiaoya for a task, run `~/.qiaoya/bin/qiaoya --json version`. If `updateAvailable` is true, tell the user to run the returned `installCommand` before continuing.
